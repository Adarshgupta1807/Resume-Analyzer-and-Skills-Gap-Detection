        ...
        preparationPlan: {
            ...
            items: {
                ...
                properties: {
                    ...
                    focus: { type: Type.STRING, description: "The main focus of this day, e.g. data structures, system design, mock interviews" },
...
async function generateInterviewReport({ resume, selfDescription, jobDescription }) {
    ...
    const prompt = `Generate an interview preparation report for a candidate with the following details:
                        ...
                        Respond strictly according to the provided JSON schema. Do not include any fields other than those defined in the schema.
`
...
// ai ke help se html create karenge phir puppeteer uss html ko pdf me convert karega
async function generateResumePdf({ resume, selfDescription, jobDescription }) {

    const resumePdfResponseSchema = {
        type: Type.OBJECT,
        properties: {
            html: { type: Type.STRING, description: "The HTML content of the resume, convertible to PDF via puppeteer" }
        },
        required: [ "html" ]
    }
